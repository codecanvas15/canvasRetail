        ...
        <table class="data-table" style="width: 100%; min-height: 255px;">
            ...
            <tbody style="vertical-align: top;">
                ...
                <tr>
                    ...
                    <td>{{ $item->qty }}</td>
                    <td>Rp.{{ number_format((float) ($item->discount ?? 0), 2, ',', '.') }}</td>
                    <td>Rp.{{ number_format((float) $item->price, 2, ',', '.') }}</td>
                    <td>Rp.{{ number_format((float) $item->total, 2, ',', '.') }}</td>
                    @php $total_bruto += (float) $item->total; @endphp
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <table class="footer">
            <tr>
                ...
                <td style="vertical-align: top; width: 20%; text-align: right;">
                    <p>Rp.{{ number_format((float) $total_bruto, 2, ',', '.') }}</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top; width: 20%; text-align: right;">
                    <p>Rp.{{ number_format((float) $data['ppn'], 2, ',', '.') }}</p>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                ...
                <td style="vertical-align: top; width: 20%; text-align: right;">
                    <p>Rp.{{ number_format((float) $data['grand_total'], 2, ',', '.') }}</p>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;">
