    ...
    public function getStockCardDetails(Request $request)
    {
        ...
        for ($i = 0; $i < sizeof($items); $i++)
        {
            ...
            for($j = 0; $j < sizeof($item); $j++)
            {
                ...
                if ($item[$j]->adjustment_total != null)
                {
                    $adjustment_total = $item[$j]->adjustment_total;
                }
                ...
                $result[$i]['items'][] = [
                    ...
                    'saldo_keluar' => sprintf("%01.2f", $value * $saldoKeluar),
                    'qty_masuk' => $saldoMasuk,
                    'saldo_masuk' => sprintf("%01.2f", $value * $saldoMasuk),
